  ...
  return (
    <div section id="media" className="min-h-screen text-white">
      ...
      >
        ...
        >
          <h1 className="text-2xl sm:text-7xl md:text-7xl font-bold tracking-tighter text-dark overflow-hidden">
            <motion.span
              initial={{ y: "100%" }}
              animate={{ y: 0 }}
          ...
          >
            <AnimatePresence mode="wait">
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-customOrange/25 to-transparent" />
              </motion.div>
            </AnimatePresence>
          </motion.div>
        </div>
        ...
        <div className="absolute right-4 top-1/2 transform -translate-y-1/2 flex flex-col space-y-4" style={{ bottom: '25%' }}>
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="p-2 md:p-4 from-customOrange/60 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-white/50"
            onClick={prevSlide}
